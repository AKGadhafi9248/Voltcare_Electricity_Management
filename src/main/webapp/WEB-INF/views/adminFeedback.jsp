...
<div class="navbar">
  ...
  <div class="heading">
    ...
    <center><h1>Feedback Management</h1></center>



    <%-- <form method="get" action="/admin/feedbacks">

        <input type="text" name="search" placeholder="Search by complaint ID, consumer number, rating..." value="${search}">
        ...
        <tbody>
            ...
            <c:forEach var="feedback" items="${feedbackList}">
                ...
                <tr>
                    ...
                    <td>${feedback.consumerNumber}</td>

                    <td>${feedback.commandDescription}</td>
